...
public:
	...
	Level_13(void)
	{
		...
		ConstructText(text_welcome, v2f(0,-35*scr_1), 10, sf::Color::Green, L"\"Miracle Paw\"", font_modeka);
	...
	virtual void Update()
	{
		...
		case STATE::play:
			...
			if(count_key < count_key_max)
			{
				...
				if(timer_key_spawn > 3750/modifier_speed)
				{
					v2f siz(7,7);
					...
					v2f spd(cosf(_a)*0.012f, sinf(_a)*0.01f);
					...
					spd = v2f(cosf(_a)*0.012f, sinf(_a)*0.01f);
